...
Workout.create(title: 'The Actual Natalia', description: 'Get fucking huge, 5x5 squat superset with deadlift', verb: 'lift', qty: 5, unit: "reps", unit_of_competition: 'lbs')
